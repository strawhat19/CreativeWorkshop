        ...
        <div className={`contact contactComponent`} {...props}>
            <div className={`contactCardMainSide`}>
                ...
                <form 
                    ...
                    className={`profileForm contactForm cwsForm fieldBG flex flexColumns alignCenter justifyCenter`}
                >

                    <h2 className={`subtitle shopSubtitle`}>Customer Account Info</h2>
